...
class Sidebar extends Component
{
    ...
    public function __construct()
    {
        ...
        if ($user->hasRole(['Admin IGT', 'Penelaah IGT', 'Admin Klarifikasi', 'Penelaah Klarifikasi'])) {
            ...
            if ($user->hasRole(['Admin Klarifikasi', 'Admin IGT', 'Admin'])) { // Hanya Admin Klarifikasi
                $adminPanelSubmenu = [];
                $adminPanelActiveRoutes = [];

                $adminPanelSubmenu[] = [
                    'name' => 'Manajemen Pengguna',
                    'route' => 'adminklarifikasi.pengguna.index',
                    'is_active' => request()->routeIs('adminklarifikasi.pengguna.index'),
                ];
                $adminPanelActiveRoutes[] = 'adminklarifikasi.pengguna.index';
            ...
            $infoSubmenu[] = ['name' => 'Kamus Data', 'route' => 'info.sop', 'is_active' => request()->routeIs('info.sop')];
