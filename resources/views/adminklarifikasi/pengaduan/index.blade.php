    ...
    <div class="px-2 mb-4">
        <div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-4">
            <h3 class="text-xl font-medium text-gray-800 dark:text-white/90">
                Dashboard Pengaduan Klarifikasi
            </h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Daftar semua pengaduan terkait layanan klarifikasi mandiri.
            </p>
        </div>
    </div>
    ...
    <div class="px-2 mb-4">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="p-4 sm:p-6">
                <table id="pengaduanTable" class="min-w-full hover ">
                    <thead class="border-y border-gray-100 dark:border-gray-800">
                        <tr>
                            ...
                            <th class="px-5 py-3 text-left font-bold whitespace-nowrap sm:px-6">
                                <p class="text-theme-lg text-gray-500 dark:text-gray-400">Pelapor</p>
                            </th>
                            <th class="px-5 py-3 text-left font-bold whitespace-nowrap sm:px-6">
        ...
        <script>
            $(document).ready(function() {
                new DataTable('#pengaduanTable', {
                    ...
                    "ajax": "{{ route('adminklarifikasi.pengaduan.data') }}",
                    "columns": [{
                            "data": "kode_pelacakan",
                            "name": "kode_pelacakan"
                        },
