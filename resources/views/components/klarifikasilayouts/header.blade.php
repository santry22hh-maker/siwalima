...
<header x-data="{ menuToggle: false }" {{-- <-- 1. Tambahkan x-data ini kembali --}}
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <button
                ...
                :class="menuToggle ? 'bg-gray-100' : ''" @click.stop="menuToggle = !menuToggle"> {{-- <-- 2. Ini sekarang akan berfungsi --}}
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'" {{-- <-- 3. Ini akan merespons tombol di atas --}}
