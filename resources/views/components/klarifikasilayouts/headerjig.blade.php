{{-- File: resources/views/components/klarifikasilayouts/headerjig.blade.php --}}
...
<header x-data="{ menuToggle: false }"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-2 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-2">

            <button :class="$store.sidebar.open ? 'lg:bg-transparent bg-gray-100' : ''"
                ...
                @click.stop="$store.sidebar.togglePin()">

                {{-- Icon hamburger (desktop) --}}
                ...
                {{-- Icon hamburger (mobile) - saat sidebar tertutup --}}
                <svg :class="$store.sidebar.open ? 'hidden' : 'block lg:hidden'" class="fill-current lg:hidden"
                ...
                {{-- Icon 'X' (mobile) - saat sidebar terbuka --}}
                <svg :class="$store.sidebar.open ? 'block lg:hidden' : 'hidden'" class="fill-current" width="24"
            ...
            <a href="/" class="lg:hidden">
                <img class="dark:hidden" src="{{ asset('src/images/logo/logo_kapitan.png') }}" alt="Logo"
                    style="height: 38px" />
                <img class="hidden dark:block" src="{{ asset('src/images/logo/logo_kapitan_dark.png') }}" alt="Logo"
                    style="height: 38px" />
            </a>
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            class="shadow-theme-md w-full items-center justify-between gap-4 px-5 py-2 lg:flex lg:justify-end lg:px-0 lg:shadow-none">
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen" x-transition
                    ...
                    <ul class="flex flex-col gap-1 border-b border-gray-200 pt-2 pb-2 dark:border-gray-700">
                        <li>
                            <a href="{{ route('profile.edit') }}"
                                class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="group text-theme-sm flex w-full items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white">
                            <svg class="fill-gray-500 group-hover:fill-gray-700" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
