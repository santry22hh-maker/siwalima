{{-- File ini berisi template HTML mentah untuk Berita Acara. --}}
{{-- Placeholder [[...]] akan diganti oleh controller showEditorBA --}}
<div style="font-family: Arial, sans-serif; font-size: 12pt; line-height: 1.5;">
    <table style="width: 100%; border-bottom: 4px solid black;">
        <tr>
            <td style="width: 15%; text-align: center;">
                {{-- Controller akan mengganti URL_LOGO_KEMENHUT dengan path yang benar --}}
                <img src="URL_LOGO_KEMENHUT" alt="Logo Kemenhut" style="width: 80px; height: auto;" />
            </td>
    ...
    <div style="text-align: center;margin-top:12px">
        ...
        <p style="margin: 0px; line-height: 1.2; text-align: center;">NOMOR:
            BA.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/BPKH.IX/SDH/PLA.01.09/B/[[nomor_ba]]/2025</p>
    </div>
    <p style="margin-top: 12px; margin-bottom: 6px; text-align: justify;">Pada hari ini, [[tanggal_terbilang]], di
    ...
    <table style="width: 100%; border-collapse: collapse; margin-left: 30px;">
        <tbody>
            <tr>
                ...
                <td style="vertical-align: top; font-weight: bold;">[[nama_pihak_pertama]]</td>
            </tr>
            <tr>
                <td style="vertical-align: top;">NIP</td>
                <td style="vertical-align: top;">:</td>
                <td style="vertical-align: top;">[[nip_pihak_pertama]]</td>
            </tr>
            <tr>
                <td style="vertical-align: top;">Jabatan</td>
                <td style="vertical-align: top;">:</td>
                <td style="vertical-align: top;">[[jabatan_pihak_pertama]]</td>
            </tr>
            <tr>
                <td style="vertical-align: top;">Instansi</td>
                <td style="vertical-align: top;">:</td>
                <td style="vertical-align: top;">Balai Pemantapan Kawasan Hutan Wilayah IX</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">:</td>
                <td style="vertical-align: top; font-weight: bold;">[[nama_pemohon]]</td>
            </tr>
            <tr>
                <td style="vertical-align: top;">NIP</td>
                <td style="vertical-align: top;">:</td>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">:</td>
                <td style="vertical-align: top;">[[no_hp]]</td>
            </tr>
            <tr>
                <td style="padding-top: 5px; padding-bottom: 15px;" colspan="3">Bertindak untuk dan atas nama
                    [[instansi]], selanjutnya disebut <strong>PIHAK KEDUA</strong></td>
            </tr>
        </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; text-align: center;">
        <thead>
            <tr style="background-color: #f2f2f2;">
                ...
                <th style="border: 1px solid black; padding: 8px;">Periode Update Data</th>
                <th style="border: 1px solid black; padding: 8px;">Format</th>
            </tr>
        </thead>
        <tbody>
            {{-- Controller akan mengganti placeholder ini dengan baris-baris <tr> --}}
            [[DATA_TABLE_ROWS]]
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td style="width: 50%; text-align: center;">
                    ...
                    <p style="margin-top: 0px; text-align: center;">NIP. [[nip_pihak_pertama]]</p>
                </td>
                <td style="width: 50%; text-align: center;">
                    ...
                    <p style="margin-top: 0px; text-align: center;">NIP. [[nip]]</p>
                </td>
            </tr>
        </tbody>
    </table>
