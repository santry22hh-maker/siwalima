        ...
        <div
            ...
            <div class="border-b border-gray-200 pb-4 mb-6 dark:border-gray-800">
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                    Kuesioner Pelayanan Publik (Layanan Klarifikasi Mandiri)
                </h3>
            ...
            {{-- Form Survey --}}
            <form action="{{ route('surveyklarifikasi.store') }}" method="POST">
                @csrf
                {{-- Input 'permohonan_id' DIHAPUS --}}
                <input type="hidden" name="permohonananalisis_id" value="{{ $permohonan->id }}">
                ...
                <div x-show="step === 1" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Data diisi dari $user yang sedang login --}}
                        <div>
                            <label for="nama_lengkap"
                                class="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-400">1. Nama Lengkap
                                <span class="text-red-500">*</span></label>
                            <x-text-input id="nama_lengkap" type="text" name="nama_lengkap" :value="old('nama_lengkap', $user->name ?? '')"
                                required />
                        ...
                        <div>
                            ...
                            <x-text-input id="instansi" type="text" name="instansi" :value="old('instansi', $user->instansi ?? '')" required />
                        ...
                        <div>
                            <label for="telepon"
                                ...
                                <span class="text-red-500">*</span></label>
                            <x-text-input id="telepon" type="text" name="telepon" :value="old('telepon', $user->telepon ?? '')" required />
                ...
                <div x-show="step === 2" class="space-y-6" style="display: none;">
                    ...
                    <div>
                        ...
                        <x-datepicker-input id="tanggal_pelayanan" name="tanggal_pelayanan" :value="old('tanggal_pelayanan')"
                            required />
                        <x-input-error :messages="$errors->get('tanggal_pelayanan')" class="mt-2" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-input-error :messages="$errors->get('kebutuhan_pelayanan')" class="mt-2" />
                    </div>
                ...
                <div x-show="step === 4" class="space-y-6" style="display: none;">
                    ...
                    <div>
                        ...
                        <x-input-error :messages="$errors->get('kritik_saran')" class="mt-2" />
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between mt-6 pt-4 border-t dark:border-gray-700">
                    ...
                    <button type="button" x-show="step < 4" @click.prevent="step++"
                        class="inline-flex items-center gap-2 rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-blue-600">
                        Berikutnya
