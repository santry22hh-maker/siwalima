    ...
    <div class="px-2 mb-4">
        <div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-4">
            <h3 class="text-xl font-medium text-gray-800 dark:text-white/90">
                Monitoring Tunggakan Survei (IGT)
            </h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Daftar permohonan yang sudah selesai. Cek siapa yang belum mengisi survei.
            </p>
        </div>
    </div>
    ...
    <div class="px-2 mb-4">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="p-4 sm:p-6">
                <table id="monitoringTable" class="min-w-full hover">
                    <thead class="border-y border-gray-100 dark:border-gray-800">
                        <tr>
                            <th class="px-5 py-3 text-left font-bold text-xs text-gray-500 uppercase">Tgl Selesai</th>
                            <th class="px-5 py-3 text-left font-bold text-xs text-gray-500 uppercase">Nama Pemohon</th>
                            <th class="px-5 py-3 text-left font-bold text-xs text-gray-500 uppercase">Instansi</th>
                            <th class="px-5 py-3 text-left font-bold text-xs text-gray-500 uppercase">Status Survey</th>
                            <th class="px-5 py-3 text-left font-bold text-xs text-gray-500 uppercase">Aksi</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
        ...
        <script>
            $(document).ready(function() {
                new DataTable('#monitoringTable', {
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('surveypenggunaan.data') }}", // Pastikan route ini ada di web.php
                    columns: [{
